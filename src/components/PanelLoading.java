...
public class PanelLoading extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        profile = new customDefaultUI.PanelTransparent();
        cmdCancel1 = new customDefaultUI.Button();
        pic = new customDefaultUI.ImageAvatar();
        cmdEdit = new customDefaultUI.EditButton();
        cmdContinue = new customDefaultUI.Button();
        loading = new customDefaultUI.PanelTransparent();
        cmdCancel = new customDefaultUI.Button();
        jLabel1 = new javax.swing.JLabel();
        message = new customDefaultUI.PanelTransparent();
        cmdCancel2 = new customDefaultUI.Button();
        ...
        ch.setFileFilter(new FileFilter() {
         ...
         if (option == JFileChooser.APPROVE_OPTION) {
             ...
             try {
                 ...
                 member.updateAvatarMember(data.getUserID(), Files.newInputStream(file.toPath()));
    ...
    private customDefaultUI.Button cmdCancel;
    private customDefaultUI.Button cmdCancel1;
    private customDefaultUI.Button cmdCancel2;
    private customDefaultUI.Button cmdContinue;
    private customDefaultUI.EditButton cmdEdit;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel lbMessage;
    private customDefaultUI.PanelTransparent loading;
    private customDefaultUI.PanelTransparent message;
    private customDefaultUI.ImageAvatar pic;
    private customDefaultUI.PanelTransparent profile;
