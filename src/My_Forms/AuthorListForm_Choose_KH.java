 ...
 */
public class AuthorListForm_Choose_KH extends javax.swing.JFrame {
    ...
    public AuthorListForm_Choose_KH() {
    ...
    private void initComponents() {
        ...
        jButton_SelectAuthor.setBackground(new java.awt.Color(53, 53, 53));
        jButton_SelectAuthor.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton_SelectAuthor.setForeground(new java.awt.Color(109, 180, 50));
        jButton_SelectAuthor.setText("CHỌN");
    ...
    private void jButton_SelectAuthorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SelectAuthorActionPerformed
        try {
            ...
            if (index == -1) {
                //JOptionPane.showMessageDialog(rootPane, "Hãy tiến hành chọn 1 Cửa Hàng");
                Notification panel = new Notification(javaswingdev.main.Main.getMain(), Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "Chưa chọn cửa hàng!");
                panel.showNotification();
            } else {
                int id = Integer.parseInt(jTable_Author.getValueAt(index, 0).toString());
                KeHoachThanhTra.displayIdCuaHang(id);
                this.dispose();
            }
