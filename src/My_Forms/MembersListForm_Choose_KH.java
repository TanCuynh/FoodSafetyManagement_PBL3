 ...
 */
public class MembersListForm_Choose_KH extends javax.swing.JFrame {
    ...
    public MembersListForm_Choose_KH() {
        initComponents();
    ...
    public MembersListForm_Choose_KH(JTextField jTextField_CuaHang) {
    ...
    private void initComponents() {
        ...
        jLabel_Form_Title.setForeground(new java.awt.Color(102, 180, 50));
        ...
        jLabel_Close.setForeground(new java.awt.Color(108, 190, 50));
        ...
        jButton_Search.setForeground(new java.awt.Color(108, 180, 50));
        ...
        jLabel_FullName.setForeground(new java.awt.Color(138, 180, 100));
        ...
        jLabel_Phone.setForeground(new java.awt.Color(138, 180, 100));
        ...
        jLabel_Gender.setForeground(new java.awt.Color(138, 180, 100));
        ...
        jLabel_Email.setForeground(new java.awt.Color(138, 180, 100));
        jLabel_Email.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel_Email.setText("Email:");
        jLabel_Email.setOpaque(true);

        jButton_SelectMember.setBackground(new java.awt.Color(102, 102, 102));
        jButton_SelectMember.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton_SelectMember.setForeground(new java.awt.Color(108, 180, 50));
        jButton_SelectMember.setText("Xác nhận");
...
//                jLabel_Country.setText(selectedmMember.getCountry());
                ...
                Notification panel = new Notification(javaswingdev.main.Main.getMain(), Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "Không tìm thấy thanh tra với ID này!");
            ...
            Notification panel = new Notification(javaswingdev.main.Main.getMain(), Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "ID thanh tra không tồn tại!");
            panel.showNotification();
        }
    ...
    private void jButton_SelectMemberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SelectMemberActionPerformed
        ...
        if (index == -1) {
            //JOptionPane.showMessageDialog(rootPane, "Hãy tiến hành chọn 1 Thanh Tra");
            Notification panel = new Notification(javaswingdev.main.Main.getMain(), Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "Chưa chọn thanh tra!");
            panel.showNotification();
        } else {
            int id = Integer.parseInt(jTable_Members_.getValueAt(index, 0).toString());

            KeHoachThanhTra.displayMemberData(id);
            this.dispose();
        }
        //get values
