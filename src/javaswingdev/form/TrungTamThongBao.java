 ...
 */
public class TrungTamThongBao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_Form_Title.setText("NHẬN THÔNG BÁO");
        ...
        jTable_Author.setEnabled(false);
    ...
    public void populateJtableWithThongBao(String query) {
        ArrayList<My_Classes.ThongBao> thongbaoList = thongbao.thongbaoList(query);

        //jtable collums
        String[] colNames = {"ID_ADMIN", "THONG BAO", "NGAY THONG BAO"};
        //jtable row
        Object[][] rows = new Object[thongbaoList.size()][colNames.length];

        for (int i = 0; i < thongbaoList.size(); i++) {
            rows[i][0] = thongbaoList.get(i).getId_user();
            rows[i][1] = thongbaoList.get(i).getMota();
            rows[i][2] = thongbaoList.get(i).getNgaythenthongbao();
        }
