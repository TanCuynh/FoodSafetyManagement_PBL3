...
import My_Forms.AuthorListForm_Choose_KH;
import My_Forms.MembersListForm_Choose_KH;
 ...
 */
public class KeHoachThanhTra extends javax.swing.JPanel {

    /**
     * Creates new form KeHoachThanhTra
     */
    public KeHoachThanhTra() {
        initComponents();
    ...
    public static void displayIdCuaHang(int id) {
        jTextField_ID_CH.setText(String.valueOf(id));
    }

    //display member in the jtextfield_member by id and fullname
    public static void displayMemberData(int id) {
        jTextField_ID_User.setText(String.valueOf(id));
    }
    ...
    private void initComponents() {
        ...
        jButton_Select_CuaHang1 = new javax.swing.JButton();
        ...
        jLabel_Form_Title.setText("CHỈNH SỬA KẾ HOẠCH THANH TRA");
        jLabel_Form_Title.setOpaque(true);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 20)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel1.setText("ID Thanh tra:");
        ...
        jButton_Select_CuaHang1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jButton_Select_CuaHang1.setText("Chọn Cửa Hàng");
        jButton_Select_CuaHang1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_Select_CuaHang1ActionPerformed(evt);
            }
        });
        ...
        jLabel3.setText("ID kế hoạch TT:");
        ...
        jLabel4.setText("* Hãy chọn từ bảng để chỉnh sửa/xóa kế hoạch thanh tra cửa hàng!");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jDateChooser_NgayTT, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(16, 16, 16)
                                        .addComponent(jTextField_ID_CH, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jButton_Select_CuaHang1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addGap(52, 52, 52)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jButton_Select_ThanhTra, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jButton_Select_CuaHang1, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGap(58, 58, 58)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextField_MoTa, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel5))
    ...
    private void jButton_Edit_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_ActionPerformed
        ...
        if (index == -1) {
            //JOptionPane.showMessageDialog(jButton_Clear, "Hãy Chọn 1 Giá Trị Từ Bảng Phân Công Kế Hoạch");
            Notification panel = new Notification(javaswingdev.main.Main.getMain(), Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "Chưa chọn kế hoạch thanh tra cần chỉnh sửa!");
            panel.showNotification();
        } else {
            {
                try {
                    int _ID_KH_TT = Integer.parseInt(jTextField_ID_KHTT.getText());
                    ...
                    String _MoTa = jTextField_MoTa.getText();
                    khtt.edit_KeHoachThanhTra(_Id_User, _Id_ch, _ngayTT, _MoTa, _ID_KH_TT);
                    //refresh the jtable after we add
                    populateJtableWithAuthor();
                    //after refresh the table we clear the textfield
                    clearData();
                } catch (Exception e) {
                    //JOptionPane.showMessageDialog(jButton_Clear, e);
                    Notification panel = new Notification(javaswingdev.main.Main.getMain(), Notification.Type.WARNING, Notification.Location.BOTTOM_RIGHT, "Chưa chọn kế hoạch thanh tra cần chỉnh sửa!");
                    panel.showNotification();
                }
            }
    ...
    public void populateJtableWithAuthor() {
        ...
        //jtable collums
        String[] colNames = {"ID", "ID_TT", "ID_CH", "Ngay TT", "Mô Tả"};
        //jtable row
        ...
        for (int i = 0; i < khttList.size(); i++) {
            ...
            rows[i][4] = khttList.get(i).getMota();
        }
...
//    
    ...
    private void jButton_Select_ThanhTraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Select_ThanhTraActionPerformed
        MembersListForm_Choose_KH membersListForm_Choose = new MembersListForm_Choose_KH();
        membersListForm_Choose.setVisible(true);
    }//GEN-LAST:event_jButton_Select_ThanhTraActionPerformed

    private void jButton_Select_CuaHang1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Select_CuaHang1ActionPerformed
        //show a form
        ...
        AuthorListForm_Choose_KH authorListForm = new AuthorListForm_Choose_KH();
        authorListForm.setVisible(true);
    }//GEN-LAST:event_jButton_Select_CuaHang1ActionPerformed
    ...
    private void jTable_KHTTMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_KHTTMouseClicked
            ...
            //get values;
            String id_KH_TT = jTable_KHTT.getValueAt(index, 0).toString();
            ...
            String MoTaTT = jTable_KHTT.getValueAt(index, 4).toString();

            ngayTT = new SimpleDateFormat("yyyy-MM-dd").parse(ngay_TT);
            jDateChooser_NgayTT.setDate(ngayTT);

            //show data in textfield
            jTextField_ID_KHTT.setText(id_KH_TT);
            jTextField_ID_User.setText(id_user);
            jTextField_ID_CH.setText(id_CH);
            jTextField_MoTa.setText(MoTaTT);

        } catch (ParseException ex) {
            Logger.getLogger(KeHoachThanhTra.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private javax.swing.JButton jButton_Select_CuaHang1;
